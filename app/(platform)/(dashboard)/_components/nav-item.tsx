...
import { BarChartBig, BellRing, GanttChart, ScrollText, Settings, Wallet } from "lucide-react";
...
export const NavItem = ({
    ...
    const routes = [
        ...
        },
        {
            ...
            href: `/group/${organization.id}/charts`
        },
        {
            label: "Reminders",
        ...
        },
        {
            ...
            href: `/group/${organization.id}/settings`
        },
    ];
